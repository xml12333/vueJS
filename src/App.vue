...
<template>
  <div class="bg-gray-700 tex-white text-center min-h-screen flex flex-col text-white">
    ...
    <main class="container mx-auto p-6 flex-1">
      ...
      <div class="text-lg">Win rate: {{ Math.round(winPrecentage) }}%</div>
    </main>
  </div>
</template>
